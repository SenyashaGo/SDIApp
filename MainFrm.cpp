...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	((CSDIAppDoc*)GetActiveDocument())->pTree = (CMyTreeView*)m_wndSplitter.GetPane(0, 0);
	((CSDIAppDoc*)GetActiveDocument())->pView = (CSDIAppView*)m_wndSplitter.GetPane(0, 1);
	
	((CMyTreeView*)m_wndSplitter.GetPane(0, 0))->m_pDoc = ((CSDIAppDoc*)GetActiveDocument());
